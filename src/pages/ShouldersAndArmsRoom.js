    ...
    <div className="text-center">
      ...
      <div className="container text-light" style={{ fontSize: "18px" }}>
        <p>
          ...
          equipment, and accessories for bicep training to help you achieve your
          arm strength and definition goals.
        </p>

        <p>
          For those who prefer the versatility and challenge of free weights, we
          have provided an additional second set of dumbbells ranging from 2.5
          kg to 50 kg. These dumbbells offer you the flexibility to customize
          your exercises and adjust the intensity of your workouts according to
          your preferences and fitness level. Whether you're looking to tone and
          strengthen your shoulders or sculpt your arms, our Shoulders and Arms
          Room is equipped to meet your fitness needs.
        </p>
      </div>
