  ...
  return (
    <div className="text-center">
      ...
      <div className="container text-light" style={{ fontSize: "18px" }}>
        ...
        <p>
          First, let’s talk about chest training. Our room boasts an impressive
          array of state-of-the-art machines and free weights, allowing you to
        ...
        <p>
          The centerpiece of our Chest and Back Room is the legendary Nautilus
          Pullover, a rare gem in the fitness world. There are only a handful of
          these machines left in the entire world, and we’re thrilled to be one
          of the few gyms that houses it. The Nautilus Pullover is renowned for
          its unique design, targeting the chest, upper back, and shoulders
          simultaneously, providing an unrivaled training experience. You’ll be
          able to isolate and work those muscles like never before and unlock
          hidden potential.
        </p>
        ...
        <p>
          ...
          posture. To optimize your back workouts, we have curated an extensive
          collection of cutting-edge equipment that targets every aspect of your
          back muscles. From rowing machines, lat pulldowns, and pull-up bars to
          cable stations and hyperextension benches, you’ll find an extensive
          array of options that cater to every fitness level and training
          preference.
        </p>
      </div>
