    ...
    <div className="text-center">
      ...
      <div className="container text-light" style={{ fontSize: "18px" }}>
        ...
        <p>
          ...
          journey, our HIIT Room offers a diverse range of equipment to cater to
          all fitness levels and goals.
        </p>

        <p>
          Concept 2's rowing machines provide a full-body workout, engaging your
          legs, core, and upper body in a coordinated effort to build strength
          and endurance. These machines are ideal for anyone looking to boost
          cardiovascular fitness, improve muscular strength, and burn calories
          efficiently.
        </p>

        <p>
          For those seeking the ultimate cycling experience, our Watt bikes are
          a game-changer. With precise power measurement and performance
          tracking capabilities, you can monitor your progress and challenge
          yourself to reach new heights in every session.
        </p>

        <p>
          Looking to sculpt a powerful upper body and core? The Skierg's offer a
          unique and effective workout that mimics the movements of
          cross-country skiing, engaging your arms, shoulders, and core muscles
          in a dynamic manner.
        </p>

        <p>
          If you're after an intense cardio workout, our Rouge Assault bikes are
          the perfect choice. With their air resistance system, you control the
          intensity by pedaling harder, making them suitable for both beginners
          and advanced users.
        </p>
      </div>
