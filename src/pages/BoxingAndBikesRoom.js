    ...
    <div className="text-center">
      ...
      <div className="container text-light" style={{ fontSize: "18px" }}>
        ...
        <p>
          ...
          unleash your inner fighter and enhance your cardiovascular endurance.
        </p>

        <p>
          In addition to the heavy bags and gloves, we have the popular
          BoxMaster, a versatile boxing training system that challenges your
          speed, accuracy, and power. Whether you’re a seasoned boxer or new to
          the sport, the BoxMaster offers an engaging and effective way to
          elevate your boxing skills.
        </p>
